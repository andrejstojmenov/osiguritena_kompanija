...
<?php
	...
	if(isset($_POST['presmetaj']))
	{
		...
		require('validation/val_deloven.php');
		if(!isset($validation_errors))
		{
			...
			switch($vid_gradba)
			{
				...
				case 'Тврда':$cena0=1550; break;
				case 'Мешовита':$cena0=2050; break;
				case 'Слаба':$cena0=2550; break;				
			}	
			if($pov <= 10&& $pov!=' ' && $pov!=0)
			{
			$cena1=1500;			
			}
			else if($pov > 10 && $pov <=20 && $pov!=' ')
			{
			$cena1=1750;
			...
			$sql="INSERT INTO `delovni`(`licna_karta`, `adresa`,`grad`,`gradba`,`povrsina`, `cena`, `user_id`)
			 VALUES
			...
			$_SESSION['success_message'] = 'Внесено е ново осигурување на деловен простор. Можете да го снимите во PDF формат и да го испечатите ';
			header('Location: deloven.php');
  ...
  <div id="main">		
	...
	<div id="site_content">		
	  ...
	  <?php if(isset($error_message)){?>
		...
		<h1 style="text-align: center">Осигурување на деловен простор</h1>
		
		  <form action="deloven.php" method="post">
