...
<?php
	...
	if(isset($_POST['presmetaj']))
	{
		...
		$sql="INSERT INTO `avtomobili`(`licna_karta`, `reg_br`,`br_shasija`,`marka`,`tip`,`sila`,`zafatnina`,`godina`,`boja`,`cena`)
			 VALUES
			...
			$_SESSION['success_message'] = 'Внесено е ново осигурување на автомобил ';
  ...
  <div id="main">		
	...
	<div id="site_content">		
	  ...
	  <?php if(isset($error_message)){?>
		...
		<h2 style="text-align: center">Осигурување на автомобили</h2>
