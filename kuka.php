...
<?php
	...
	if(isset($_POST['presmetaj']))
	{
		...
		require('validation/val_kuka.php');
		if(!isset($validation_errors))
		{
			...
			case 'Тврда':$cena0=3200; break;
			case 'Мешовита':$cena0=3750; break;
			case 'Слаба':$cena0=4500; break;				
			}	
			if($pov <= 50&& $pov!=' ' && $pov!=0)
			{
			$cena1=2400;			
			...
			$sql="INSERT INTO `kuki`(`licna_karta`, `adresa`,`grad`,`gradba`,`povrsina`, `cena`, `user_id`)
			 VALUES
  ...
  <div id="main">		
	...
	<div id="site_content">		
	  ...
	  <?php if(isset($error_message)){?>
		...
		<h1 style="text-align: center">Осигурување на куќа</h1>
		
		  <form action="kuka.php" method="post">
